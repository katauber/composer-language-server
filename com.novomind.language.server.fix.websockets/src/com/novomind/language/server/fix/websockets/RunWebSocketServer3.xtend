package com.novomind.language.server.fix.websockets
...
class RunWebSocketServer3 {
	...
	def static void main(String[] args) {
		...
		var FixWebSocketServer server = new FixWebSocketServer(new InetSocketAddress(host, port)) {
...
class FixWebSocketServer extends WebSocketServer {
